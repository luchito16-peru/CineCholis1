...
<%
    ...
    if (nombre == null || apellidos == null || celular == null || dni == null || email == null || password == null ||
        ...
        if (registrado) {
            ...
            out.println("<script>alert('Usuario registrado exitosamente.'); window.location='/CineCholis/loginusuario_intranet.jsp';</script>");
        } else {
            // Hubo un error al registrar el usuario
            out.println("<script>alert('Error al registrar el usuario. Intenta nuevamente.'); window.location='/CineCholis/registerant_intranet.jsp';</script>");
        }
    }
%>